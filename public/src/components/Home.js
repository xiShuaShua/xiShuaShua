    ...
    return <div className="row my-nav my-bg my-white-color my-home">
      <div className="row my-nav-padding">
        <ul className="nav">
          ...
          <li className="col-xs-4" id="personal" onClick={this.toggle}><span className="glyphicon glyphicon-user">个人中心</span></li>
          {/*</ReactRouter.Link>*/}
      ...
      <div style={sideBar} className="row my-side-bar" id="sideBar">
        <ul className="nav text-left">
          <ReactRouter.Link to="/login">
            <li className="my-white-color"><span className="glyphicon glyphicon-plus my-logo-padding"></span>用户登陆</li>
          </ReactRouter.Link>
          <ReactRouter.Link to="/register">
            <li className="my-white-color"><span className="glyphicon glyphicon-pencil my-logo-padding my-white-color"></span>用户注册</li>
          </ReactRouter.Link>
